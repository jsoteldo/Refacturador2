...
public class DlgTransferenciasNueva extends JDialog {
    ...
    private void jbInit() throws Exception {
        ...
        pnlDirigido.setBounds(new Rectangle(460, 0, 310, 40));
  ...
  */
    ...
    private boolean grabar() {
        ...
        try {
            ...
            for (int k = 0; k < tblListaProductos.getRowCount(); k++) {
                String mensaje =
                    DBInventario.getStockProducto(tblListaProductos.getValueAt(k, 0).toString(), 
                                                  tblListaProductos.getValueAt(k,                                                                                                                              4).toString());
            ...
            DBInventario.grabaInicioFinCreaTransferencia(numera,"F"); 
            //JCHAVEZ 10122009 registra fecha fin de creacion de transferencia
     ...
     * @since 26.09.2016
     */
    private boolean registroAlmacen(){
        boolean bRetorno = true;
        try{
            if(VariablesInventario.bAlmacenMixto &&
                VariablesInventario.vCodDestino_Transf.equals("")){
                
                ArrayList array = new ArrayList();
                DBInventario.getDatosTransporte(array, VariablesInventario.strCodAlmacen);
                
                if (array.size() > 0) {
                    array = (ArrayList)array.get(0);
                    
                    VariablesInventario.vCodDestino_Transf = VariablesInventario.strCodAlmacen;
                    VariablesInventario.vDestino_Transf = array.get(0).toString();
                    VariablesInventario.vRucDestino_Transf = array.get(1).toString();
                    VariablesInventario.vDirecDestino_Transf = array.get(2).toString();
            ...
            log.error("",e);
            bRetorno = false;
            FarmaUtility.showMessage(this, "Error al recuperar Almacen", null);
        }
        return bRetorno;
    }
}
