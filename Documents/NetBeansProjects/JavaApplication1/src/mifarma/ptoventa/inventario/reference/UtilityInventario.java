...
public class UtilityInventario {
    ...
    public static void imprimirConstanciaRecepcion(ArrayList arrayCab) {
        try {
            ...
            List vListaDatos2 =
                DBInventario.getDatoConstanciaRecepcionMD(arrayCab.get(4).toString(), arrayCab.get(7).toString(),
                                                          arrayCab.get(8).toString(),
    ...
    public static boolean getInd_NuevoProceso() {
        boolean flag = false;
        String rpta = "";
        try {
            rpta = DBInventario.getInd_NuevoProceso();
        } catch (SQLException e) {
    ...
    public static boolean is_Migra_Sap() {
        boolean isMigra = false;
        try {

            String indicador = DBInventario.isMigraSap(FarmaVariables.vCodGrupoCia, FarmaVariables.vCodLocal);
