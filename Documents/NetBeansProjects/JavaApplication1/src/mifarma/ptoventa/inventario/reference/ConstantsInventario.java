...
public class ConstantsInventario {
    ...
    { new FarmaColumnData("No. Nota", 80, JLabel.CENTER), new FarmaColumnData("Tipo", 70, JLabel.LEFT),
      ...
      //LTAVARA 2017.09.20
      new FarmaColumnData("Tip.Proceso", 95, JLabel.LEFT),
    new FarmaColumnData("TipoCotizacion", 0, JLabel.LEFT)
      };
 ...
 public static final Object[] defaultValuesListaProductosPedidoReposicionDetalle =
    ...
    { new FarmaColumnData("No. Transf.", 80, JLabel.LEFT), new FarmaColumnData("Local Dest.", 110, JLabel.LEFT),
    ...
    { new FarmaColumnData("Fecha", 120, JLabel.CENTER), 
      ...
      new FarmaColumnData("", 0, JLabel.CENTER) //IND REVERSA
        } ;
    ...
    //
    public static final String NOM_HASHTABLE_CMBTIPOPROCESO = "cmbTipoProceso";
    ...
    public static final String NOM_HASHTABLE_CMBEMPRESA = "cmbEmpresa";
    ...
    { new FarmaColumnData("Nº O/C", 100, JLabel.CENTER), new FarmaColumnData("Local", 35, JLabel.RIGHT),
      ...
      new FarmaColumnData("PROC_OC_CAB", 0, JLabel.RIGHT),
    ...
    public static final int TIP_PED_ESP_NOR=0;
    public static final int TIP_PED_ESP_INS=1;
    /*** fin CCASTILLO 10/10/2016 ***/
    
    //INI LTAVARA - 2017.06.19
    public static final FarmaColumnData[] columnsResumenProdIngreado =
    { new FarmaColumnData("Codigo", 60, JLabel.CENTER), new FarmaColumnData("Producto", 220, JLabel.LEFT),
      new FarmaColumnData("Cantidad",80, JLabel.RIGHT), new FarmaColumnData("Prec. Unitario",80, JLabel.RIGHT),
       new FarmaColumnData("Importe Total", 90, JLabel.RIGHT) };
    public static final Object[] defaultResumenProdIngreado = { " ", " ", " ", " ", " "};
    //FIN LTAVARA - 2017.06.19

    /**
     * 
     */
    public static final FarmaColumnData[] columnsListaRecepCab_OC =
    { new FarmaColumnData("Nº O/C", 100, JLabel.CENTER), 
      new FarmaColumnData("Sec.Recepción", 100, JLabel.RIGHT),
    new FarmaColumnData("Fec. Emisión.", 120, JLabel.CENTER), 
      new FarmaColumnData("Nº Items", 60, JLabel.RIGHT), 
      new FarmaColumnData("Responsable", 120, JLabel.RIGHT),
      new FarmaColumnData("Serie Doc.", 80, JLabel.RIGHT),
      new FarmaColumnData("Numero Doc.", 120, JLabel.RIGHT),
      };
    public static final Object[] defaultListaRecepCab_OC = { " ", " ", " ", " ", " "};

    /////////////////////////////////////////////////////////////////
    public static final FarmaColumnData[] columnsListaRecepDet_OC =
    { 
      new FarmaColumnData("NºOrden", 80, JLabel.CENTER), 
      new FarmaColumnData("Código", 80, JLabel.CENTER),
      new FarmaColumnData("Nombre Producto", 250, JLabel.LEFT), 
      new FarmaColumnData("Unidad Presentación", 170, JLabel.CENTER), 
      new FarmaColumnData("Cantidad", 120, JLabel.RIGHT)
    };
    
    public static final Object[] defaultListaRecepDet_OC = { " ", " ", " ", " ", " "};
    /////////////////////////////////////////////////////////////////
}
