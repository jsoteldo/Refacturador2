...
public class DlgListaPedidosEspeciales extends JDialog {
    ...
    /*** Inicio ccastillo 10/10/2016 ***/
        ...
        public DlgListaPedidosEspeciales(Frame parent, String title, boolean modal,int tipoPedido) {     
        super(parent, title, modal);
            VariablesInventario.vTipoPedidoEsp=tipoPedido;
    ...
    private void jbInit() throws Exception {
        ...
        this.setTitle("Pedidos Especiales Realizados");
            ...
            this.setTitle("Pedidos Especiales de Insumos Realizados");
        /*** Fin  ccastillo 10/10/2016 ***/
    ...
    private void cerrarVentana(boolean pAceptar) {
        ...
        VariablesInventario.vTipoPedidoEsp=-1;
        /*** Fin CCASTILLO 10/10/2016 ***/
