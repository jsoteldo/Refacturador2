...
public interface DAOInventario extends DAOTransaccion {
    ...
    public String grabarCabDetRecep(String vCodGrupoCia, String vCodCia, String vCodLocal, String vIdUsu,
                                    ...
                                    //2017.06.19 LTAVARA - Datos de transaccion monedero
                                     String vNombreTrans, String vDNITrans, String vPlacaTrans) throws SQLException;
    ...
    /**
     * Detalle de Guia que no mueven stock
     * @author CCASTILLO
     * @since 17.08.2017
     * @param cCodGrupoCia
     * @param cCodLocal
     ...
     * @throws SQLException
     */
    public ArrayList<ArrayList<String>> getDetGuiaNoMueveStock(String cCodGrupoCia,
                                                               String cCodLocal,
                                                               String cNumNotaEs) throws SQLException;
    ...
    /**
     * Obtiene indicador si permite recepcionar Orden de Compra vencida
     * @author AOVIEDO
     * @since 16.01.2017
     */
    public String getIndicadorPermiteOCvencida() throws SQLException;
