...
public class MBInventario implements DAOInventario {
    ...
    public String grabarCabDetRecep(String vCodGrupoCia, String vCodCia, String vCodLocal, String vIdUsu,
                                    ...
                                    //2017.06.19 LTAVARA - Datos de transaccion monedero
                                     String vNombreTrans, String vDNITrans, String vPlacaTrans
                                    ) throws SQLException {
        String bEstado = "";
        Map<String, Object> mapParametros = new HashMap<String, Object>();
        ...
        //LTAVARA 2017.06.19 DATO DEL TRANSPORTISTA  
        mapParametros.put("nNombreTrans_in", vNombreTrans);
        mapParametros.put("nDNITrans_in", vDNITrans);
        mapParametros.put("nPlacaTrans_in", vPlacaTrans);
    ...
    public void grabarDetRecep(String vCodGrupoCia, String vCodCia, String vCodLocal, String vIdUsu,
                               ...
                               String vSecOC//,
                               //String dFecVenc //ASOSA - 04/12/2017 - CAMBIOSMD
                               ) throws SQLException {
        Map<String, Object> mapParametros = new HashMap<String, Object>();
        ...
        //mapParametros.put("dFechVenc_in", dFecVenc.trim()); //ASOSA - 04/12/2017 - CAMBIOSMD
     ...
     */
    @Override
    public ArrayList<ArrayList<String>> getDetGuiaNoMueveStock(String cCodGrupoCia, String cCodLocal,String cNumNotaEs) {
        Map<String, Object> mapParametros = new HashMap<String, Object>();
        ArrayList<ArrayList<String>> lstListado;
        List<BeanResultado> lstRetorno;
        mapParametros.put("cCodGrupoCia_in", cCodGrupoCia);
        mapParametros.put("cCodLocal_in", cCodLocal);
        mapParametros.put("cNumNotaEs_in", cNumNotaEs);
        openConnection();
        try {
            mapper.getDetGuiaNoMueveStock(mapParametros);
        } finally {
            sqlSession.close();
        }
        lstRetorno = (List<BeanResultado>)mapParametros.get("listado");
    ...
    public String getIndicadorPermiteOCvencida() {
        ...
        try {
            mapper.getIndicadorPermiteOCvencida(mapParametros);
        } finally {
            sqlSession.close();
        }
        estado = (String)mapParametros.get("Respuesta");
