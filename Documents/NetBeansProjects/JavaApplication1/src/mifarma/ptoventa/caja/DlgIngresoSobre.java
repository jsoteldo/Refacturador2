...
public class DlgIngresoSobre extends JDialog {
    ...
    private void jbInit() throws Exception {
        ...
        jLabelWhite1.setText("Total Ingreso :  "+ConstantesUtil.simboloSoles);
        ...
        T_lblTotalVenta.setText("Total Venta Acumulada : "+ConstantesUtil.simboloSoles);
        T_lblTotalVenta.setBounds(new Rectangle(5, 0, 155, 20));
        T_lblTotalVenta.setToolTipText("Total Venta Acumulada : "+ConstantesUtil.simboloSoles);
...
//            VariablesPtoVenta.vTipImpresion="";//jvara 08-08-2017
