...
public class DlgNuevoRemito extends JDialog {
    ...
    //private JTextField txtPrecinto = new JTextField(8); // JVARA 08-08-2017 
    private JTextFieldSanSerif txtPrecinto = new JTextFieldSanSerif(); // JVARA 08-08-2017 
    ...
    private void jbInit() throws Exception {
        ...
        lblRegsitros_T1.setText("Total Soles : "+ConstantesUtil.simboloSoles);
    ...
    private boolean validarCampos() {
        ...
        if (txtPrecinto.isVisible() == true && txtPrecinto.getText().trim().length() == 0) {
            ...
            FarmaUtility.showMessage(this, "Debe ingresar un número de remito válido", txtNumRemito);  // JVARA 08-08-2017
            result = false;
   ...
   result=false;
          ...
          else if (txtPrecinto.getText().trim().length()< 8) {   // JVARA 08-08-2017 INICIO
            FarmaUtility.showMessage(this, "Debe ingresar un número de precinto válido", txtPrecinto);
            result = false;
        } 
        
        // JVARA 08-08-2017 FIN
         /*** INICIO CCASTILLO 17/08/2017 ***/
        else if (validaCaracterAlfaNumerico(txtPrecinto.getText().trim())) {
            FarmaUtility.showMessage(this, "El Precinto debe tener solo letras o números", txtPrecinto);
            result = false;
        }
    ...
    /*** INICIO CCASTILLO 17/08/2017 ***/
    public boolean validaCaracterAlfaNumerico(String cadena){
        boolean flag=false;
        for (int i=0;i<cadena.length();i++){
                if(cadena.charAt(i)>=65 && cadena.charAt(i)<=90){
                    ...
                    log.info("Precinto : '"+cadena.charAt(i)+"' es Otro caracter");
                    //flag=true;
                    return true;
                }
        }
