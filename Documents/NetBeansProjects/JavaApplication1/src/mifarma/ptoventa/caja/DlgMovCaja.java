...
public class DlgMovCaja extends JDialog {
    ...
    private JLabel lblAlerta_1 = new JLabel();
    private JLabel lblAlerta_2 = new JLabel();
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(385, 362));
        ...
        lblEsc.setBounds(new Rectangle(275, 300, 85, 20));
        lblF11.setText("[ F11 ] Aceptar");
        lblF11.setBounds(new Rectangle(160, 300, 100, 20));
        jPanel2.setBounds(new Rectangle(20, 45, 340, 245));
        ...
        lblMensajeCajero.setText("Ud. tiene asignado un fondo de sencillo de " + ConstantesUtil.simboloSoles +
                                 "XXX.XX"); //ASOSA, 20.06.2010
        ...
        lblAlerta_1.setText("Alerta de Cierre de Caja 1");
        lblAlerta_1.setBounds(new Rectangle(15, 190, 315, 25));
        lblAlerta_1.setSize(new Dimension(380, 20));
        lblAlerta_1.setForeground(Color.red);
        lblAlerta_1.setFont(new Font("Dialog", 1, 13));
        lblAlerta_2.setText("Alerta de Cierre de Caja 2");
        lblAlerta_2.setBounds(new Rectangle(15, 215, 315, 20));
        lblAlerta_2.setSize(new Dimension(380, 20));
        lblAlerta_2.setForeground(Color.red);
        lblAlerta_2.setFont(new Font("Dialog", 1, 12));
        jPanel2.add(lblAlerta_2, null);
        jPanel2.add(lblAlerta_1, null);
    ...
    private void initialize() {
        ...
        if (VariablesCaja.vTipMovCaja.equals(ConstantsCaja.MOVIMIENTO_APERTURA)) {
            ...
            try {
                lblAlerta_1.setText(DBCaja.obtenerAlerta1());
                lblAlerta_2.setText(DBCaja.obtenerAlerta2());
            } catch (Exception ex) {
                lblAlerta_1.setText("");
                lblAlerta_2.setText("");
                log.error("", ex);
                FarmaUtility.showMessage(this, "Error al obtener Alertas de Cierre de Caja :\n" +
                        ex.getMessage(), null);
            }
                ...
                if (Double.parseDouble(VariablesFondoSencillo.vMontoAsignado.trim()) > 0.00) {
                    ...
                    int rptaInt =
                        UtilityFondoSencillo.rptaConfirmDialogDefaultNo(this,
                            ...
                            ConstantesUtil.simboloSoles + VariablesFondoSencillo.vMontoAsignado +
                     ...
                     * */
                    pMensaje =
                            "Ud. tiene asignado un fondo de sencillo de " + ConstantesUtil.simboloSoles + VariablesFondoSencillo.vMontoAsignado; //ASOSA, 18.06.2010
                }
