...
public class VariablesCaja {
    ...
    public static String vInd_ImprimeQR = "N";
//    public static String vCodTipProcPago = "";
    ...
    public  static ArrayList<Object> vArrayCabecera = new ArrayList<Object>();
    public static String vTmpCodigo = "";
    public static String vTipoRec = ""; 
    ...
    /**
     * Indicadores para ver anulacion forzada de orviis
     * @Author RARGUMEDO
     * @since  12.04.18
     */
    public static String codAnul_Orviis="";
    public static String ptoMsj_Orviis="";
    /**
    ...
    public static boolean vCerrarVentanaTotalAnularPedido=false;
    ...
    /*INI ZB 20190719 AGREGAR VARIABLES TEMPORALES*/
    public static String vCodFormaPagoTemp = "";
    public static String vDescFormaPagoTemp = "";
    public static String vDescMonedaPagoTemp = "";
    public static String vValMontoPagadoTemp = "";
    public static String vValMontoCreditoTemp = "";
    public static String vValTotalPagadoTemp = "";
    public static String vNumPedVtaNCRTemp = "";
    /*FIN ZB 20190719 AGREGAR VARIABLES TEMPORALES*/
