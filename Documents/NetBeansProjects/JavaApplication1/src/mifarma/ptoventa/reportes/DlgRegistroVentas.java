...
public class DlgRegistroVentas extends JDialog {
    ...
    private void listadoDetalleVentas() {
        ...
        dlgDetalleRegistroVentas.setAnuladoPor( ((String)tblRegistroVentas.getValueAt(tblRegistroVentas.getSelectedRow(), 14)).trim());
        dlgDetalleRegistroVentas.setNroCompOrigen(((String)tblRegistroVentas.getValueAt(tblRegistroVentas.getSelectedRow(), 13)).trim());
