...
public class ConstantsReporte {
    ...
    new FarmaColumnData("NRO. Comprobante origen", 0, JLabel.CENTER), new FarmaColumnData("Anulado por", 0, JLabel.CENTER)
      };
    ...
    { new FarmaColumnData("Tipo", 120, JLabel.CENTER), new FarmaColumnData("Numero", 100, JLabel.CENTER),
      new FarmaColumnData("Fecha", 120, JLabel.CENTER),
        ...
        new FarmaColumnData("Total "+ConstantesUtil.simboloSoles, 75, JLabel.RIGHT), new
    ...
    { new FarmaColumnData("Codigo", 60, JLabel.CENTER), // 1
        new FarmaColumnData("Vendedor", 190, JLabel.LEFT), // 2
        new FarmaColumnData("Tot.C.IGV.", 90, JLabel.RIGHT), // 3
        new FarmaColumnData("Tot.S.IGV", 90, JLabel.RIGHT), // 4
        new FarmaColumnData("GG", 90, JLabel.RIGHT), // 5
        new FarmaColumnData("G", 90, JLabel.RIGHT), // 6
        //ERIOS 2.3.3 Nueva columna GP
        new FarmaColumnData("GP", 90, JLabel.RIGHT), // 7
        new FarmaColumnData("Otros", 90, JLabel.RIGHT), // 8
        new FarmaColumnData("Otros", 0, JLabel.RIGHT), // 9 G-OTROS NUEVO
        new FarmaColumnData("Participación %", 0, JLabel.RIGHT), // 10
        new FarmaColumnData("Servicios", 80, JLabel.RIGHT), // 11
        new FarmaColumnData("%", 80, JLabel.RIGHT), // 12
        //ERIOS 02.04.2014 Nuevos Campos (EDMUNDO)
        new FarmaColumnData("Sub Total.", 80, JLabel.RIGHT), // 13
        new FarmaColumnData("Calidad Inv.(*)", 80, JLabel.CENTER), // 14
        new FarmaColumnData("At. Cliente (*)", 80, JLabel.CENTER), // 15
        new FarmaColumnData("Total.", 80, JLabel.RIGHT), // 16
        new FarmaColumnData("Num.Ped.", 80, JLabel.RIGHT), // 17
        new FarmaColumnData("ind_tipo_fila", 0, JLabel.RIGHT), // 18
        new FarmaColumnData("Correlativo", 0, JLabel.RIGHT), // 19
        new FarmaColumnData("orden", 0, JLabel.RIGHT), // 20
        new FarmaColumnData("login", 0, JLabel.RIGHT), // 21
        new FarmaColumnData("Total KMS", 100, JLabel.RIGHT), // 22
        new FarmaColumnData("Monto Total KMS", 100, JLabel.RIGHT) // 23
    } ;
    ...
    { new FarmaColumnData("Vendedor", 180, JLabel.LEFT), new FarmaColumnData("Unid Vendidas", 120, JLabel.RIGHT),
      new FarmaColumnData("Total "+ConstantesUtil.simboloSoles, 110, JLabel.RIGHT) };
 ...
 * */
    ...
    public static final FarmaColumnData columnsListaVentasVendedorNuevo[] =
    { new FarmaColumnData("Codigo", 60, JLabel.CENTER), // 1
        new FarmaColumnData("Vendedor", 190, JLabel.LEFT), // 2
        new FarmaColumnData("Tot.C.IGV.", 90, JLabel.RIGHT), // 3
        new FarmaColumnData("Tot.S.IGV", 90, JLabel.RIGHT), // 4
        new FarmaColumnData("GG", 90, JLabel.RIGHT), // 5
        new FarmaColumnData("G", 0, JLabel.RIGHT), // 6
        //ERIOS 2.3.3 Nueva columna GP
        new FarmaColumnData("GP", 0, JLabel.RIGHT), // 7
        new FarmaColumnData("Otros", 0, JLabel.RIGHT), // 8
        new FarmaColumnData("Otros", 90, JLabel.RIGHT), // 9 G-OTROS NUEVO
        new FarmaColumnData("Participación %", 90, JLabel.RIGHT), // 10
        new FarmaColumnData("Servicios", 80, JLabel.RIGHT), // 11
        new FarmaColumnData("%", 80, JLabel.RIGHT), // 12
        //ERIOS 02.04.2014 Nuevos Campos (EDMUNDO)
        new FarmaColumnData("Sub Total.", 80, JLabel.RIGHT), // 13
        ...
        new FarmaColumnData("Total KMS", 100, JLabel.RIGHT), // 22
        new FarmaColumnData("Monto Total KMS", 100, JLabel.RIGHT), // 23
        new FarmaColumnData("Monto Total GG", 0, JLabel.RIGHT) // 24 //RMULLISACA 26/08/2019
    } ;
    
    public static final Object[] defaultValuesListaVentasVendedorNuevo =
    { " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " " };
