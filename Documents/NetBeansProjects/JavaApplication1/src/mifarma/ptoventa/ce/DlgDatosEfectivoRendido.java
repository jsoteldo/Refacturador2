...
public class DlgDatosEfectivoRendido extends JDialog {
    ...
    private void chkKeyPressed(KeyEvent e) {
        ...
        if (mifarma.ptoventa.reference.UtilityPtoVenta.verificaVK_F1(e)) {
            ...
            if(VariablesCajaElectronica.vCodCuadratura.trim().equalsIgnoreCase(ConstantsCajaElectronica.CUADRATURA_DCTO_PERSONAL)){
                if(FarmaUtility.isInteger(txtNumeroPedido.getText().trim()))
                    funcion();
                else
                   FarmaUtility.showMessage(this, "Solo debe ingresar números en el campo NUMERO PEDIDO", txtNumeroPedido);
            }else
                funcion();
