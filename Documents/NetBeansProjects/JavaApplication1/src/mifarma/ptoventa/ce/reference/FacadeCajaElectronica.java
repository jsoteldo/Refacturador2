...
public class FacadeCajaElectronica {
    ...
    private DAOCajaElectronica daoCajaElectronicaGestorX;
    ...
    //JVARA
    public String enviaSolicitudVBCajero(String pCodGrupoCia, String pCodLocal, Double pMontoSobrante) {
        String bRetorno = "";
        DAORACCajaElectronica daoRACCajaElectronica = null;
        try {
            daoRACCajaElectronica = FactoryCajaElectronica.getDAORACCajaElectronica(TipoImplementacionDAO.GESTORTX);
            
            daoRACCajaElectronica.openConnection(); 
            bRetorno= daoRACCajaElectronica.enviaSolicitudVBCajero(pCodGrupoCia, pCodLocal, pMontoSobrante,VariablesCajaElectronica.vSecMovCaja);
            daoRACCajaElectronica.commit();            
        } catch (Exception e) {
            daoRACCajaElectronica.rollback();
            log.error("", e);
            return null;
        }
