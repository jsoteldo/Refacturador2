...
public class ConstantsCajaElectronica {
    ...
    { new FarmaColumnData("Id.", 70, JLabel.CENTER), new FarmaColumnData("Desc. Cuadratura", 280, JLabel.LEFT),
      new FarmaColumnData("Total "+ConstantesUtil.simboloSoles, 76, JLabel.RIGHT), new FarmaColumnData("Tipo", 0, JLabel.CENTER) };
    ...
    { new FarmaColumnData("Cod.", 50, JLabel.CENTER), new FarmaColumnData("Desc. Cuadratura", 205, JLabel.LEFT),
      new FarmaColumnData("Monto "+ConstantesUtil.simboloSoles, 78, JLabel.RIGHT) };
    ...
    { new FarmaColumnData("Forma Pago", 135, JLabel.LEFT), new FarmaColumnData("Moneda", 70, JLabel.LEFT),
      new FarmaColumnData("Monto", 65, JLabel.RIGHT), new FarmaColumnData("Total("+ConstantesUtil.simboloSoles+")", 70, JLabel.RIGHT),
      new FarmaColumnData("", 0, JLabel.LEFT), //codigo de forma pago
      /*** INICIO CCASTILLO 21/08/2017 ***/
      new FarmaColumnData("Ind Dollar", 0, JLabel.LEFT),
    ...
    { new FarmaColumnData("Pedido", 90, JLabel.LEFT), new FarmaColumnData("Comp.", 85, JLabel.LEFT),
      ...
      new FarmaColumnData("Total("+ConstantesUtil.simboloSoles+")", 80, JLabel.RIGHT), new FarmaColumnData("Proveedor", 80, JLabel.LEFT),
    ...
    { new FarmaColumnData("Id.", 70, JLabel.CENTER), new FarmaColumnData("Desc. Efectivo Rendido", 300, JLabel.LEFT),
      new FarmaColumnData("Total "+ConstantesUtil.simboloSoles, 76, JLabel.RIGHT), new FarmaColumnData("", 0, JLabel.LEFT) };
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Tipo", 85, JLabel.CENTER),
      new FarmaColumnData("Comprobante", 100, JLabel.LEFT), new FarmaColumnData("Total "+ConstantesUtil.simboloSoles, 80, JLabel.RIGHT),
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Forma Pago", 125, JLabel.LEFT),
      ...
      new FarmaColumnData("I. Total "+ConstantesUtil.simboloSoles, 85, JLabel.RIGHT), new FarmaColumnData("E.Financiera", 110, JLabel.CENTER),
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Servicio", 90, JLabel.LEFT),
      ...
      new FarmaColumnData("I. Total "+ConstantesUtil.simboloSoles, 85, JLabel.RIGHT), new FarmaColumnData("F.Documento", 90, JLabel.LEFT),
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("T.Moneda", 80, JLabel.LEFT),
      new FarmaColumnData("Importe", 80, JLabel.RIGHT), new FarmaColumnData("I. Total "+ConstantesUtil.simboloSoles, 85, JLabel.RIGHT),
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Documento", 80, JLabel.LEFT),
      ...
      new FarmaColumnData("Total", 80, JLabel.LEFT), new FarmaColumnData("I. Total "+ConstantesUtil.simboloSoles, 85, JLabel.RIGHT),
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Forma Pago", 150, JLabel.LEFT),
      ...
      new FarmaColumnData("I. Total "+ConstantesUtil.simboloSoles, 85, JLabel.RIGHT), new FarmaColumnData("Glosa.", 150, JLabel.LEFT),
      new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("T. Dinero", 80, JLabel.LEFT),
      new FarmaColumnData("T. Moneda", 80, JLabel.LEFT), new FarmaColumnData("Importe", 80, JLabel.RIGHT),
      new FarmaColumnData("I. Total "+ConstantesUtil.simboloSoles, 85, JLabel.RIGHT), new FarmaColumnData("Serie", 130, JLabel.LEFT),
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("T.Documento", 85, JLabel.CENTER),
      ...
      new FarmaColumnData("Importe.", 75, JLabel.RIGHT), new FarmaColumnData("I. Total "+ConstantesUtil.simboloSoles, 85, JLabel.RIGHT),
    ...
    { new FarmaColumnData("Usuario", 70, JLabel.CENTER), new FarmaColumnData("Nombre", 90, JLabel.CENTER),
      ...
      new FarmaColumnData("Importe", 85, JLabel.RIGHT), new FarmaColumnData("Importe Total "+ConstantesUtil.simboloSoles, 100, JLabel.RIGHT),
    ...
    { new FarmaColumnData("Usuario", 70, JLabel.CENTER), new FarmaColumnData("Nombre", 90, JLabel.CENTER),
      ...
      new FarmaColumnData("Importe Total "+ConstantesUtil.simboloSoles, 100, JLabel.RIGHT), };
    public static final Object[] defaultListaDetalleRobo = { " ", " ", " ", " ", " ", " " };

    public static final FarmaColumnData[] columsListaDetalleDeficitCajero =
    { new FarmaColumnData("Usuario", 70, JLabel.CENTER), new FarmaColumnData("Nombre", 90, JLabel.CENTER),
      new FarmaColumnData("Caja", 50, JLabel.CENTER), new FarmaColumnData("Turno", 50, JLabel.CENTER),
      new FarmaColumnData("Importe", 80, JLabel.RIGHT), new FarmaColumnData("Importe Total "+ConstantesUtil.simboloSoles, 100, JLabel.RIGHT), };
    ...
    { new FarmaColumnData("Usuario", 70, JLabel.CENTER), new FarmaColumnData("Nombre", 90, JLabel.CENTER),
      ...
      new FarmaColumnData("Comprobante", 90, JLabel.LEFT), new FarmaColumnData("Importe", 80, JLabel.RIGHT),
      new FarmaColumnData("Importe Total "+ConstantesUtil.simboloSoles, 100, JLabel.RIGHT), new FarmaColumnData("Vuelto", 80, JLabel.RIGHT), };
    public static final Object[] defaultListaDetalleOtrasCuadraturas = { " ", " ", " ", " ", " ", " ", " ", " ", " " };
    
    /*** INICIO CCASTILLO 22/08/2017 ***/
    public static final FarmaColumnData[] columsListaDetalleCotizacionCompetencia=
    { new FarmaColumnData("Usuario", 50, JLabel.CENTER), new FarmaColumnData("Nombre", 90, JLabel.CENTER),
      new FarmaColumnData("Caja", 50, JLabel.CENTER), new FarmaColumnData("Turno", 50, JLabel.CENTER),
      new FarmaColumnData("Tipo", 60, JLabel.LEFT), new FarmaColumnData("Serie", 0, JLabel.CENTER),
      new FarmaColumnData("Comprobante", 90, JLabel.LEFT), new FarmaColumnData("Importe", 80, JLabel.RIGHT),
      new FarmaColumnData("Importe Total "+ConstantesUtil.simboloSoles, 100, JLabel.RIGHT), new FarmaColumnData("Vuelto", 70, JLabel.RIGHT), 
      new FarmaColumnData("Val.Manual", 60, JLabel.CENTER), 
      new FarmaColumnData("Glosa Man.", 0, JLabel.LEFT),
      new FarmaColumnData("Val.Web", 60, JLabel.CENTER), 
      new FarmaColumnData("Glosa Web", 0, JLabel.LEFT),
      //
      new FarmaColumnData("CodGrupoCia", 0, JLabel.LEFT), 
      new FarmaColumnData("CodLocal", 0, JLabel.LEFT),
      new FarmaColumnData("SecMovCaja", 0, JLabel.LEFT), 
      new FarmaColumnData("SecCuadraturaCaja", 0, JLabel.LEFT),
      new FarmaColumnData("Num.Nota", 0, JLabel.LEFT),
     new FarmaColumnData("fecha Cotizacion", 0, JLabel.LEFT),
    new FarmaColumnData("nomSustento", 0, JLabel.LEFT)
      };
    public static final Object[] defaultListaDetalleCotizacionCompetencia = { " ", " ", " ", " ", " ", " ", " ", " ", " "
                                                                            , " ", " ", " ", " "
                                                                            , " ", " ", " ", " " , " ", " " ," "};
    /*** INICIO CCASTILLO 22/08/2017 ***/
    ...
    { new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Tipo", 80, JLabel.LEFT),
      ...
      new FarmaColumnData("Importe", 80, JLabel.RIGHT), new FarmaColumnData("I. Total "+ConstantesUtil.simboloSoles, 85, JLabel.RIGHT),
      new FarmaColumnData("I.Perdido "+ConstantesUtil.simboloSoles, 85, JLabel.RIGHT), new FarmaColumnData("Proveedor", 120, JLabel.LEFT),
      new FarmaColumnData("Glosa", 150, JLabel.LEFT), new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.LEFT), //sec
    ...
    public static final FarmaColumnData[] columnsEliminacionCotizacionCompetencia_Turno = { //ASOSA, 12.08.2010
        new FarmaColumnData("Sel", 30, JLabel.CENTER), new FarmaColumnData("Documento", 100, JLabel.LEFT),
        new FarmaColumnData("Tipo", 80, JLabel.LEFT), new FarmaColumnData("Fecha", 90, JLabel.LEFT),
        new FarmaColumnData("Total", 80, JLabel.RIGHT), new FarmaColumnData("I. Total "+ConstantesUtil.simboloSoles, 85, JLabel.RIGHT),
        new FarmaColumnData("Glosa", 150, JLabel.LEFT), new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        new FarmaColumnData("", 0, JLabel.RIGHT), //relleno
        ...
        new FarmaColumnData("", 0, JLabel.LEFT), //feccierre
        /*** INICIO CCASTILLO 21/08/2017 ***/
        /*new FarmaColumnData("Val. Man.", 60, JLabel.CENTER), 
        new FarmaColumnData("Glosa Man.", 0, JLabel.LEFT),
        new FarmaColumnData("Val. Web", 60, JLabel.CENTER), 
        new FarmaColumnData("Glosa Web", 0, JLabel.LEFT),*/
        /*** FIN CCASTILLO 21/08/2017 ***/
    ...
    { new FarmaColumnData("Nota de Credito", 120, JLabel.LEFT),
      ...
      new FarmaColumnData("Importe("+ConstantesUtil.simboloSoles+")",80, JLabel.RIGHT)
      };
    ...
    {  new FarmaColumnData("N° Caja", 60, JLabel.CENTER),
     new FarmaColumnData("Cajero", 200, JLabel.LEFT),
      ...
      new FarmaColumnData("Importe("+ConstantesUtil.simboloSoles+") ",100, JLabel.CENTER)
    ...
    /*** INICIO CCASTILLO 22/08/2017 ***/
    public static final String COD_VAL_MANUAL = "350";
    public static final String COD_VAL_WEB = "351";
    /*** FIN CCASTILLO 22/08/2017 ***/

    public static final FarmaColumnData[] columsListaNotaDetalleCotizacionCompetencia =
    { new FarmaColumnData("Codigo", 50, JLabel.LEFT), new FarmaColumnData("Descripcion", 170, JLabel.LEFT),
    ...
    public static final Object[] defaultListaNotaDetalleCotizacionCompetencia = { " ", " ", " ", " ", " ", " ", " ", " ", " ", " " };
}
