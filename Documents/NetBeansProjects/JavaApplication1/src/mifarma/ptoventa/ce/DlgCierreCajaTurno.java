...
public class DlgCierreCajaTurno extends JDialog {
    ...
    boolean flagDollar=false;
    private JPanelTitle pnlMensajeDollar = new JPanelTitle();
    private JLabelOrange lblMensajeDollar = new JLabelOrange();
    ...
    private void jbInit() throws Exception {
        ...
        lblSubTotalCuadraturas_T.setText("Sub Total : "+ConstantesUtil.simboloSoles);
        ...
        lblMontoTotalSistema_T.setText("Monto Registrado por Sistema : "+ConstantesUtil.simboloSoles);
        ...
        /*** INICIO CCASTILLO 21/08/2017 ***/
        pnlMensajeDollar.setBounds(new Rectangle(15, 315, 130, 25));
        pnlMensajeDollar.setBackground(new Color(255, 255, 255));
        //lblMensajeDollar.setBounds(new Rectangle(15, 315, 130, 25));
        lblMensajeDollar.setText("MONEDA DOLLAR");
        lblMensajeDollar.setBounds(new Rectangle(0, 5, 130, 15));
        lblMensajeDollar.setForeground(Color.red);
        lblMensajeDollar.setFont(new Font("DialogInput", 1, 15));
        pnlMensajeDollar.setVisible(flagDollar);
        /*** INICIO CCASTILLO 21/08/2017 ***/
        ...
        lblMontoTotalCierre_T.setText("Cierre : "+ConstantesUtil.simboloSoles);
        lblMontoTotalCierre_T.setBounds(new Rectangle(5, 10, 60, 15));
        lblFaltante_T.setText("con faltante de "+ConstantesUtil.simboloSoles);
        ...
        lblFondoSencillo_T.setText("Monto Fondo de Sencillo : "+ConstantesUtil.simboloSoles);
        ...
        lblSubTotalRecaud.setText("Sub Total: "+ConstantesUtil.simboloSoles);
        ...
        /*** INICIO CCASTILLO 21/08/2017 ***/
        pnlMensajeDollar.add(lblMensajeDollar,null);
        jPanelWhite1.add(pnlMensajeDollar, null);
        /*** FIN CCASTILLO 21/08/2017 ***/
    ...
    /*** INICIO CCASTILLO 21/08/2017 ***/ 
     private void pintaFilasLabStkCritico() {
          ArrayList aux = new ArrayList();
          flagDollar=false;
          for (int i = 0; i < tableModelFormasPago.data.size(); i++) {
              if ((getValueColumna(i,
                                   5)).trim().equalsIgnoreCase("S")) {
                  aux.add(String.valueOf(i));
                  flagDollar=true;
              }
        
          }
          FarmaUtility.initSimpleListCleanColumns(tblFormasPago,
                                                  tableModelFormasPago,
                                                  ConstantsCajaElectronica.columsListaFormasPagoCierre,
     ...
     public String getValueColumna(int Fila, int Columna) {
          String pValor =
              FarmaUtility.getValueFieldArrayList(tableModelFormasPago.data,
                                                  Fila, Columna);
          return pValor;
      }
        ...
        if (VariablesCajaElectronica.vIndVBCajero.equalsIgnoreCase(FarmaConstants.INDICADOR_N) &&
            ...
            if (getDeter_neces_fpFSEN()) { //ASOSA, 21.06.2010
                ...
                if (!validaRangoComprobantesIngresados()) {
                    ...
                    //JVARA 29-08-2017 VALIDACIONES PARA EL CAJERO                   
                ...
                if (VariablesCajaElectronica.vIndVBCajero.equalsIgnoreCase(FarmaConstants.INDICADOR_N)) {
                    ...
                    if (JConfirmDialog.rptaConfirmDialog(this,
                        ...
                        if (actualizaIndicadorVB(VariablesCajaElectronica.vSecMovCaja, FarmaConstants.INDICADOR_S,
                            ...
                            cargaListaFormasPagoCierre();
                            if(VariablesCajaElectronica.vFaltante != 0){
                                cargaListaCuadraturasCierre();
                            }
                            evaluaTotales();
                        }
    ...
    private void evaluaTotales() {
        ...
        if (montoFaltante < 0) {
            lblFaltante_T.setText("con sobrante de "+ConstantesUtil.simboloSoles);
            //montoFaltante = 0.00;
    ...
    /*private void obtieneComprobantesMinMax()
  {
    ...
    private void imprimeCierreTurno() {
     ...
     VariablesCajaElectronica.vNumTurno, true);*/
            ...
            vPrint.printBold(FarmaPRNUtility.llenarBlancos(55) + "Sub Total "+ConstantesUtil.simboloSoles+" " +
            ...
            vPrint.printBold(FarmaPRNUtility.llenarBlancos(47) + "Sub Total "+ConstantesUtil.simboloSoles+" " +
    ...
    /*private boolean validaComprobantesIngresados()
  {
     ...
     * @SINCE 03.03.2010
     * */
    private String getCadenaSinSeparadoresMiles(String cadena){
        String cadenaResultante="";
        for(int i=0;i<cadena.length();i++){
            if(cadena.charAt(i)!=','){
                 cadenaResultante=cadenaResultante+cadena.charAt(i);
             }
    ...
    private boolean validaMontoDeclarado() {
        ...
        try {
            ...
            // JVARA 08-09-2017 INICIO  VALIDACION VB CAJERO
            String montosCierreTurno=DBCajaElectronica.obtieneMontosCierreTurno(VariablesCajaElectronica.vSecMovCaja,
                                                   VariablesCajaElectronica.vDiaVenta,
                                                   lblSubTotalCuadraturas.getText().trim(),
                                                   lblSubTotalFormaPago.getText().trim()
                                                   );  
            String[] arrayMontos = montosCierreTurno.split("@"); 
            System.out.print("monto sobrante..." + arrayMontos[0].trim());
            
            String cadenaSinSeparadoresMiles = getCadenaSinSeparadoresMiles(arrayMontos[0].trim());
            System.out.print("monto sobrante sin Separadores Miles .." + cadenaSinSeparadoresMiles);
           
           VariablesCajaElectronica.vMontoSobrante=  FarmaUtility.getDecimalNumber(cadenaSinSeparadoresMiles);
            System.out.print(" VariablesCajaElectronica.vMontoSobrante .." +  VariablesCajaElectronica.vMontoSobrante);
            // JVARA 08-09-2017 FIN
            ...
            System.out.println("error codigo  john ..." + sql.getErrorCode());
            System.out.println("error mensaje sql  john ..." + sql.getMessage());
            ...
            //JVARA 05-09-2017 INICIO
            else if (sql.getErrorCode() == 20103) {
                            FarmaUtility.showMessage(this, sql.getMessage() + "\n" +
                                   " ¡VERIFIQUE Y CORRIJA!", txtFecha);
                            valor = false;            
            }
            else if (sql.getErrorCode() == 20104) {
                FacadeCajaElectronica f = new FacadeCajaElectronica();
                
                String rpta=f.enviaSolicitudVBCajero(FarmaVariables.vCodGrupoCia,FarmaVariables.vCodLocal,VariablesCajaElectronica.vMontoSobrante);
             
           String cadenaError = sql.getMessage().substring(10, 122) ;   
                System.out.print("cadenaError ..." + cadenaError);
               
                String[] arrayMensajeError = cadenaError.split("@"); 
                
                            FarmaUtility.showMessage(this, arrayMensajeError[0]  + "\n" +  arrayMensajeError[1] + "\n" +  
                                   " ¡VERIFIQUE Y CORRIJA!", txtFecha);
                            valor = false;            
            }   
            //JVARA 05-09-2017 fin 
