...
public class ConstantsRecetario {
    ...
    { new FarmaColumnData("Sel", 30, JLabel.LEFT), new FarmaColumnData("Codigo", 60, JLabel.CENTER),
      ...
      new FarmaColumnData("Precio ("+ConstantesUtil.simboloSoles+")", 80, JLabel.RIGHT), new FarmaColumnData("Cant.", 80, JLabel.CENTER),
    ...
    { new FarmaColumnData("Codigo", 60, JLabel.LEFT), new FarmaColumnData("Descripción", 250, JLabel.LEFT),
      ...
      new FarmaColumnData("Precio Unit.("+ConstantesUtil.simboloSoles+")", 100, JLabel.RIGHT), //antes 0
        ...
        new FarmaColumnData("Sub-Total("+ConstantesUtil.simboloSoles+")", 100, JLabel.RIGHT),
