...
public class DlgListaImpresoras extends JDialog {
    ...
    private JButton btnPruebaCupon = new JButton();
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(659, 315));
        ...
        btnPruebaCupon.setText("jButton1");
        btnPruebaCupon.setBounds(new Rectangle(660, 105, 40, 90));
        btnPruebaCupon.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    btnPruebaCupon_actionPerformed(e);
                }
            });
        scrListaImpresoras.getViewport().add(tblListaImpresoras, null);
        jContentPane.add(btnPruebaCupon, null);
    ...
    private void btnPruebaCupon_actionPerformed(ActionEvent e) {
