...
FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_ADMIN_USU.USU_EXISTE_LOGIN_DUPLICADO(?,?,?)", parametros);
    ...
    public static void obtieneListaTrabajadores(FarmaTableModel pTableModel,String flagOtraCia,String flagActivos) throws SQLException { // JVARA 16-08-2017
        pTableModel.clearTable();
        parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodCia);
        parametros.add(flagOtraCia);// JVARA 16-08-2017
        parametros.add(flagActivos); // JVARA 16-08-2017
        log.debug("PTOVENTA_ADMIN_USU.USU_LISTA_TRABAJADORES(?,?,?)" + parametros); // JVARA 16-08-2017
        FarmaDBUtility.executeSQLStoredProcedure(pTableModel, "PTOVENTA_ADMIN_USU.USU_LISTA_TRABAJADORES(?,?,?)", // JVARA 16-08-2017
                                                 parametros, false);
    }
    
    public static void obtieneTodosTrabajadores(FarmaTableModel pTableModel) throws SQLException {
        pTableModel.clearTable();
        parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodCia);
        parametros.add("S");
     ...
     * @since  : 12.07.2007
     */
    public static String buscaUsuSinCajaAsignada(String sec_usuario) throws SQLException {
        parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(sec_usuario.trim());
...
FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_ADMIN_USU.USU_VERIFICA_EXISTENCIA_CARNE(?,?,?)", parametros);
    ...
    public static String validarInactivarUsuarioMaeTrab(String documentoIdentidad) throws SQLException {
        String rpta = "";
        parametros = new ArrayList();
        parametros.add(documentoIdentidad);

        log.debug("inactivarUsuarioMaeTrab - documento" + documentoIdentidad);
        rpta = FarmaDBUtility.executeSQLStoredProcedureStr("FARMA_MAE_TRAB.VALIDA_PERMITE_INACTIVAR(?)", parametros);
        return rpta;
    }
}
