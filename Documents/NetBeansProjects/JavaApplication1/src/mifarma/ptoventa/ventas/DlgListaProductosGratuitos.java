...
public class DlgListaProductosGratuitos extends JDialog {
    ...
    private void cancelaOperacion() {
        ...
        for (int i = 0; i < VariablesVentas.vArrayList_PedidoVenta.size(); i++) {
            ...
            for (int j = 0; j < UtilityCalculoPrecio.getSizeDetalleVenta(); j++) {
                codProdTmp = UtilityCalculoPrecio.getBeanPosDetalleVenta(j).getVCodProd();
        ...
        for (int i = 0; i < UtilityCalculoPrecio.getSizeDetalleVenta(); i++) {
            codProd = UtilityCalculoPrecio.getBeanPosDetalleVenta(i).getVCodProd();
            String cantidad = UtilityCalculoPrecio.getBeanPosDetalleVenta(i).getVCtdVta();
            String cantidadTmp = "";
