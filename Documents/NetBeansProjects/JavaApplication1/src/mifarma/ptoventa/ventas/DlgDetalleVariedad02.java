...
public class DlgDetalleVariedad02 extends JDialog {

    /* ************************************************************************ */
    /*                          DECLARACION PROPIEDADES                         */
    /* ************************************************************************ */
    private static final Logger log = LoggerFactory.getLogger(DlgDetalleVariedad02.class);
    ...
    public DlgDetalleVariedad02() {
        this(null, "", false, "");
    }

    public DlgDetalleVariedad02(Frame parent, String title, boolean modal, String indTipoPack) {
    ...
    private void separarProductosArray() {
        ...
        for (int c = 0; c < listCloned.size(); c++) {
            ...
            stock = (int)Integer.parseInt(FarmaUtility.getValueFieldArrayList(myArray, c, 9).trim());
