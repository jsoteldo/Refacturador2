...
public class DlgDetalleVariedad extends JDialog {

    /* ************************************************************************ */
    /*                          DECLARACION PROPIEDADES                         */
    /* ************************************************************************ */
    private static final Logger log = LoggerFactory.getLogger(DlgDetalleVariedad.class);
    ...
    public DlgDetalleVariedad() {
        this(null, "", false, "");
    }

    public DlgDetalleVariedad(Frame parent, String title, boolean modal, String indTipoPack) {
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(656, 500));
        ...
        pnlStock.setBounds(new Rectangle(5, 85, 625, 20));
        ...
        jScrollPane1.setBounds(new Rectangle(5, 105, 625, 105));
        ...
        lblEsc.setBounds(new Rectangle(545, 435, 85, 20));
        lblF11.setText("[ F11 ] Aceptar");
        lblF11.setBounds(new Rectangle(430, 435, 110, 20));
        ...
        txtCantidad.setBounds(new Rectangle(240, 420, 60, 20));
        ...
        lblUnidadT5.setBounds(new Rectangle(5, 415, 95, 20));
        btnCantidad.setText("Cantidad");
        btnCantidad.setMnemonic('C');
        btnCantidad.setBounds(new Rectangle(180, 415, 65, 20));
        ...
        txtPrecioTotalRedondeado.setBounds(new Rectangle(105, 420, 60, 20));
        txtPrecioTotalRedondeado.setEnabled(false);

        btlLista1.setText("Prod. Lista 1: ");
        btlLista1.setBounds(new Rectangle(10, 60, 75, 15));
        ...
        txtProd1.setBounds(new Rectangle(90, 55, 245, 20));
        ...
        jLabelFunction1.setBounds(new Rectangle(345, 235, 140, 20));
        jLabelFunction1.setText("[ ENTER ] Ingresar");
        jLabelFunction2.setBounds(new Rectangle(345, 55, 140, 20));
        ...
        lblF2.setBounds(new Rectangle(385, 405, 120, 20));
        lblF2.setText("[ F2 ] Mover Lista 1");
        lblF3.setBounds(new Rectangle(510, 405, 117, 19));
        lblF3.setText("[ F3 ] Mover Lista 2");
    ...
    private void listarCantidadesPromocion() {
        UtilityVentas.listarCantidadesPromocion(listaLimites, VariablesVentas.vCodProm);
    }
    ...
    private void calcularNumerosPack() {
        try {
            ...
            if (indTipoPack.equals(ConstantsVentas.IND_PACK_VARIEDAD)) {
                ...
                for (int c = 0; c < tableModelListaPaquete2.data.size(); c++) {
                    ...
                    if (!cantComodin.equals("0")) {
                        precioComodin = listComodin.get(4).toString();
                        porcComodin = listComodin.get(8).toString();
                        total2 = total2 + (double)Double.parseDouble(precioComodin) * (100.0 - (double)Double.parseDouble(porcComodin))/100;
                    }
                }
            ...
            double totalRedondeadoNum = UtilityVentas.Redondear(total2, 2);
            ...
            if (VariablesVentas.vIndAplicaRedondeo.equalsIgnoreCase("S")) {
                ...
                VariablesVentas.vVentaTotal = FarmaUtility.formatNumber(UtilityVentas.Redondear(total2, 2), 3);
    ...
    private void AceptarProductosComprometidos() {
         ...
         */
                ...
                myArray2.add(UtilityVentas.Redondear(totaltemp, 2) + "");
    ...
    */
    ...
    private boolean verificaProducto() {
        ...
        //INI AOVIEDO 09/02/2018
        if (indTipoPack.equals(ConstantsVentas.IND_MULTIPACK)) {
            return true;
        }
        //FIN AOVIEDO 09/02/2018
    ...
    private void llamarSetearCantidad(String opcion,
        ...
        if (isThereStock(opcion)) {
            DlgCantDetaVariedad dlgCantDetaVariedad = new DlgCantDetaVariedad(myParentFrame, "", true);
            dlgCantDetaVariedad.setOpcion(opcion);
            dlgCantDetaVariedad.setCantPermitidaPaquete(getCantPermitidaPaquete(opcion));
            dlgCantDetaVariedad.setVisible(true);
            if (FarmaVariables.vAceptar) {
                if (opcion.equals("1")) {
                    ...
                    FarmaGridUtils.showCell(tblpaquete2, indice, 5);
                }
            } else {
                VariablesVentas.cantidadDetalleVariedad = "0";
            }
            calcularNumerosPack();
        }        
    }
    ...
    private boolean isThereStock(String opcion) {
        ...
        if (opcion.equals("1")) {
            ...
            stock = FarmaUtility.getValueFieldArrayList(tableModelListaPaquete2.data, tblpaquete2.getSelectedRow(), 6).toString();
        }
        ...
        if (opcion.equals("1")) {
            for (int c = 0; c < tableModelListaPaquete1.data.size(); c++) {
                ...
                if (!fila.get(0).toString().equals(FarmaUtility.getValueFieldArrayList(tableModelListaPaquete1.data, tblpaquete1.getSelectedRow(), 0))) {
                    valor = valor + (int)Integer.parseInt(fila.get(5).toString());
                }                
            }
        } else {
            for (int c = 0; c < tableModelListaPaquete2.data.size(); c++) {
                ArrayList fila = (ArrayList)tableModelListaPaquete2.data.get(c);
                if (!fila.get(0).toString().equals(FarmaUtility.getValueFieldArrayList(tableModelListaPaquete2.data, tblpaquete2.getSelectedRow(), 0))) {
                    valor = valor + (int)Integer.parseInt(fila.get(5).toString());
                }                
            }
        }
    ...
    private int getCantMaxPaquete(String opcion) {
        int valor = (int)Integer.parseInt(txtCantidad.getText());
