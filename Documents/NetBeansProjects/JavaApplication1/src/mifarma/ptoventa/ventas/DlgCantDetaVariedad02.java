            ...
            if (cant > cantPermitidaPaquete) {
                ...
                if (cantPermitidaPaquete == 0) {
                    if(getTipoPantallaXoY().equals("REGALO")){
                        FarmaUtility.showMessage(this, "El regalo ya está completo", txtCantidad);
                    }else
                        FarmaUtility.showMessage(this, "El pack ya está completo", txtCantidad);
                } else {
                    FarmaUtility.showMessage(this, "Ingresar un máximo de " + cantPermitidaPaquete + " unidades", txtCantidad);
                }
            } 
        /*}else{
            FarmaUtility.showMessage(this, "La cantidad ingresada debe ser múltiplo de " + cantFraccionada, txtCantidad);
            flag = false;
        }*/
