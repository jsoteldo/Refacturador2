...
public class DlgIngresoCantidadReceta extends JDialog {
    ...
    private void obtieneInfoProdEnArrayList(ArrayList pArrayList) {
        try {
            DBVentas.obtieneInfoDetalleProducto(pArrayList, VariablesCentroMedico.vCod_Prod);
    ...
    private void muestraInfoDetalleProd() {
        ...
        if (myArray.size() == 1) {
            VariablesCentroMedico.vStk_Prod = ((String)((ArrayList)myArray.get(0)).get(0)).trim();
            VariablesCentroMedico.vStk_Prod_Fecha_Actual = ((String)((ArrayList)myArray.get(0)).get(2)).trim();
            //if (VariablesReceta.vIngresaCant_ResumenPed)
            //{
            VariablesCentroMedico.vVal_Prec_Vta = ((String)((ArrayList)myArray.get(0)).get(3)).trim();
            VariablesCentroMedico.vPorc_Dcto_1 = ((String)((ArrayList)myArray.get(0)).get(6)).trim();
            //}
            VariablesCentroMedico.vUnid_Vta = ((String)((ArrayList)myArray.get(0)).get(4)).trim();
            VariablesCentroMedico.vVal_Bono = ((String)((ArrayList)myArray.get(0)).get(5)).trim();
            VariablesCentroMedico.vVal_Prec_Lista = ((String)((ArrayList)myArray.get(0)).get(7)).trim();
        } else {
        ...
        lblFechaHora.setText(VariablesCentroMedico.vStk_Prod_Fecha_Actual);
        lblStock.setText("" + (Integer.parseInt(VariablesCentroMedico.vStk_Prod)));
        //lblStock.setText(VariablesReceta.vStk_Prod);
        lblCodigo.setText(VariablesCentroMedico.vCod_Prod);
        lblDescripcion.setText(VariablesCentroMedico.vDesc_Prod);
        lblLaboratorio.setText(VariablesCentroMedico.vNom_Lab);
        lblUnidad.setText(VariablesCentroMedico.vUnid_Vta);
        txtPrecioVenta.setText(VariablesCentroMedico.vVal_Prec_Vta);
        lblDcto.setText(VariablesCentroMedico.vPorc_Dcto_1);
    ...
    private void this_windowOpened(WindowEvent e) {
        ...
        cantInic = FarmaUtility.trunc(FarmaUtility.getDecimalNumber(VariablesCentroMedico.vCant_Ingresada_Temp));
    ...
    private void aceptaCantidadIngresada() {
        ...
        VariablesCentroMedico.vCant_Ingresada = txtCantidad.getText().trim();
        VariablesCentroMedico.vVal_Prec_Vta = txtPrecioVenta.getText().trim();
        cerrarVentana(true);
    }
