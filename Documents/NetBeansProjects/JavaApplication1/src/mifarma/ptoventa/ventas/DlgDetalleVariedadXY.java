...
public class DlgDetalleVariedadXY extends JDialog {
    /* ************************************************************************ */
    /*                          DECLARACION PROPIEDADES                         */
    /* ************************************************************************ */
    private static final Logger log = LoggerFactory.getLogger(DlgDetalleVariedadXY.class);
    ...
    public DlgDetalleVariedadXY() {
        this(null, "", false, "");
    }

    public DlgDetalleVariedadXY(Frame parent, String title, boolean modal, String indTipoPack) {
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(716, 500));
        ...
        lblEsc.setBounds(new Rectangle(600, 390, 85, 20));
        lblF11.setText("[ F11 ] Aceptar");
        lblF11.setBounds(new Rectangle(485, 390, 110, 20));
        ...
        lblUnidadT5.setBounds(new Rectangle(5, 390, 95, 20));
        btnCantidad.setText("Cantidad Variedad");
        btnCantidad.setBounds(new Rectangle(190, 390, 105, 20));
        ...
        btlLista1.setText("Prod. Lista 1: ");
        ...
        jTextArea1.setBounds(new Rectangle(5, 240, 685, 140));
        ...
        lblPrecioTotalRedondeado.setBounds(new Rectangle(100, 390, 80, 20));
        ...
        lblCantidad.setBounds(new Rectangle(300, 390, 105, 20));
        ...
        lblMsgCompletado.setBounds(new Rectangle(50, 430, 540, 20));
    ...
    private boolean isValidoStockProductosSeleccionados() {
        ...
        String indStock;
        String descProd; 
        for (int r = 0; r < tableModelListaPaquete1.data.size(); r++) {
            list = (ArrayList)tableModelListaPaquete1.data.get(r);
    ...
    private void borrarProdSinStockLista1() {
        ...
        for (int r = 0; r < tableModelListaPaquete1.data.size(); r++) {
            ...
            if (stock.trim().equals("0.00") || stock.trim().equals("") || stock.trim().equals("0") || stock.trim().equals(" ")) {
                removeItemArray(tableModelListaPaquete1.data, codProd, 0);
                borrarProdSinStockLista1();
            }
        }        
    }
                ...
                if (!VariablesVentas.venta_producto_virtual) {
                    ...
                    if (!VariablesVentas.accionModificar) {                    
                        if (verificaProducto()) {
                            ...
                            FarmaVariables.vAceptar = false;
                            FarmaUtility.showMessage(this, "La Promoción tiene productos ya seleccionados", txtProd1);
                        }
                    } else {
                        aceptarComprometidos();
                    }
    ...
    private void listaPaquetes() {
        try {
            // cargarDatos();
            DBVentas.obtieneListadoPaquetes02(VariablesVentas.vArrayList_Prod_XY, VariablesVentas.vCodProm.trim());
            DBVentas.listaPaquete1_02(tableModelListaPaquete1, VariablesVentas.vCodProm);
            int cantmax = Integer.parseInt(FarmaUtility.getValueFieldArrayList(tableModelListaPaquete1.data, 0, 10));
            ...
            FarmaUtility.showMessage(this, "Ocurrió un error al listar los paquetes.\n" +
        ...
        try {
            ...
            if (indTipoPack.equals(ConstantsVentas.IND_PACK_VARIEDAD) ||
                ...
                if(listaLimites.size() > 0 && listaLimites != null && !listaLimites.isEmpty()){
                    cantMaxPaq1 = Integer.parseInt(((ArrayList)listaLimites.get(0)).get(0).toString());
                    //porcPaquete2 = ((ArrayList)listaLimites.get(0)).get(3).toString();
                }
                
                int cantPacks = 0;
                try{
                    cantPacks = Integer.parseInt(lblCantidad.getText().trim());
                } catch (Exception e){
                    cantPacks = 0;
                }
                int cont = 0;
                ...
                */
                ...
                for (int c = 0; c < tableModelListaPaquete1.data.size(); c++) {
                    listComodin = (ArrayList)tableModelListaPaquete1.data.get(c);
                    ...
                    if (!cantComodin.equals(" ")) {                        
                        ...
                        /*for (int i = 0; i < Integer.parseInt(cantComodin); i++) {
                            cont = cont + 1;
                ...
                total1 = FarmaUtility.getDecimalNumber(FarmaUtility.getValueFieldJTable(tblpaquete1, 0, 9));
    ...
    private void separarProductosArray() {
        ...
        int stock = 0;
        String codProd = "";
        ArrayList listCloned = (ArrayList)VariablesVentas.vArrayList_Prod_XY.clone();
        for (int c = 0; c < listCloned.size(); c++) {
            listTemp = new ArrayList();
            stock = Integer.parseInt(FarmaUtility.getValueFieldArrayList(VariablesVentas.vArrayList_Prod_XY, c, 9).trim());
            codProd = FarmaUtility.getValueFieldArrayList(VariablesVentas.vArrayList_Prod_XY, c, 0);
            if (stock > 1) {
                listTemp.add((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(c));
                ((ArrayList)listTemp.get(0)).set(9, "1");
                removeItemArray(VariablesVentas.vArrayList_Prod_XY, codProd, 0);
                for (int i = 0; i < stock; i++) {
                    VariablesVentas.vArrayList_Prod_XY.add(((ArrayList)listTemp.get(0)).clone());
                }
            }
        }
    }
    ...
    private void ponerPorcetajesDsctoMyArray() {        
        int cantMaxPaq2 = Integer.parseInt(((ArrayList)listaLimites.get(0)).get(1).toString());
        //double porcPaquete2 = (int)Integer.parseInt(((ArrayList)listaLimites.get(0)).get(3).toString());
        //SE LE APLICA EL PORCENTAJE DEL PAQUETE 1
        //double porcPaquete2 = Double.parseDouble(((ArrayList)listaLimites.get(0)).get(2).toString());
        int cantPacks = Integer.parseInt(lblCantidad.getText().trim());
        ...
        log.debug("ANTES PONER PORC: " + VariablesVentas.vArrayList_Prod_XY);
        
        //for (int c = 0; c < (cantMaxPaq2 * cantPacks); c++) {
        for (int c = 0; c < VariablesVentas.vArrayList_Prod_XY.size(); c++) {
            //int i = c + cantPacks;
            int i = c;
            
            list = (ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i);
            precio = Double.parseDouble(list.get(5).toString().trim());
            ...
            /*
            ((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(c)).set(5,  " " + precioDescontado);//precio descontado
            ((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(c)).set(18, " " + porcPaquete2);//porcentaje
            ((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(c)).set(20, " " + (precioDescontado - precio));//precio descontado - precio
    */
            
        }
        log.debug("DESPUES PONER PORC: " + VariablesVentas.vArrayList_Prod_XY);
    }
    ...
    private void aceptarComprometidos() {
        ...
        if (isPackCompleto()) {
            ...
            if (Integer.parseInt(lblCantidad.getText().trim()) > VariablesVentas.vcantMaxVta) {
                FarmaUtility.showMessage(this, "Se excede la cantidad máxima de ventas.", txtProd1);
                FarmaVariables.vAceptar = false;
                return;
            }
            ...
            log.debug("VariablesVentas.vArrayList_Prod_XY xxx " + VariablesVentas.vArrayList_Prod_XY);
    ...
    private void limpiarProductosVariedad() {
        ...
        String codProd;
        for (int c = 0; c < VariablesVentas.vArrayList_Prod_XY.size(); c++) {
            list = (ArrayList)VariablesVentas.vArrayList_Prod_XY.get(c);
            codProd = list.get(0).toString();
            ...
            for (int i = 0; i < tableModelListaPaquete1.data.size(); i++) {
                
                listPq = (ArrayList)tableModelListaPaquete1.data.get(i);
                ...
                if (codProd.equals(codProdPq)) {
                    if (cantPq.equals(" ")) {
                        ...
                        ((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(c)).set(9, cantPq);
                    }
                    break;
                }
            }
        ...
        log.info("ARRAY PROCESADO: " + VariablesVentas.vArrayList_Prod_XY);
    ...
    private boolean validaStockActual() {
        ...
        for (int i = 0; i < VariablesVentas.vArrayList_Prod_XY.size(); i++) {
            a2 = (ArrayList)(VariablesVentas.vArrayList_Prod_XY.get(i));
            b.add((ArrayList)(a2.clone()));
        }
        ArrayList auxNuevo = VariablesVentas.vArrayList_Prod_XY;
    ...
    private void AceptarProductosComprometidos() {
        ...
        try {
            ...
            log.debug("VariablesVentas.vArrayList_Prod_XY.size() " + VariablesVentas.vArrayList_Prod_XY.size());
            log.debug("VariablesVentas.vArrayList_Prod_XY  () " + VariablesVentas.vArrayList_Prod_XY);
            double igvTotal = 0;
            for (int i = 0; i < VariablesVentas.vArrayList_Prod_XY.size(); i++) {
                ArrayList myArray2 = new ArrayList();
                //
                VariablesVentas.vCod_Prod = ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(0)).trim();
                VariablesVentas.vDesc_Prod = ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(1)).trim();
                VariablesVentas.vUnid_Vta = ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(2)).trim();
                VariablesVentas.vNom_Lab = ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(3)).trim();
                VariablesVentas.vStk_Prod = ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(4)).trim();
                VariablesVentas.vVal_Prec_Vta = ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(5)).trim();
                ...
                VariablesVentas.vTotalPrecVtaProd =
                        ...
                        Integer.parseInt((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(9));

                VariablesVentas.vVal_Bono = ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(16)).trim();
                VariablesVentas.vVal_Frac = ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(7)).trim();
                //dubilluz 2017.05.02
                VariablesVentas.vCant_Ingresada = FarmaUtility.getValueFieldArrayList(VariablesVentas.vArrayList_Prod_XY, i, 9);
                ...
                log.debug(" Promociones cantidad unidad: " + (String)(((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(9)));
                log.debug(" Promociones VariablesVentas.vCant_Ingresada : " + VariablesVentas.vCant_Ingresada);


                VariablesVentas.vVal_Prec_Lista = ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(10)).trim();
                VariablesVentas.vPorc_Igv_Prod = ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(11)).trim();
                String valIgv =
                ...
                VariablesVentas.vTipoProductoVirtual = ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(14)).trim();
         ...
         * @since  : 03.07.2007
         */
                VariablesVentas.vPorc_Dcto_1 = ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(17)).trim();
                VariablesVentas.vPorc_Dcto_2 = ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(18)).trim();
                VariablesVentas.vVal_Prec_Pub = ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(19)).trim();


                VariablesVentas.vAhorroPack = ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(20)).trim(); //JCHAVEZ 20102009
                VariablesVentas.vInd_Origen_Prod_Prom =
                        ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(21)).trim(); //JCHAVEZ 20102009
                double totaltemp =
                ...
                VariablesVentas.vPrecFijo = ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(22)).trim();
                ...
                indFidelizado = ((String)((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(i)).get(23)).trim();
            }
    ...
    */
    ...
    private boolean verificaProducto() {
        ...
        for (int i = 0; i < VariablesVentas.vArrayList_PedidoVenta.size(); i++) {            
            ...
            if (!aux.get(0).toString().equals(codProd)) {
                log.debug("Entro");
                for (int j = 0; j < VariablesVentas.vArrayList_Prod_XY.size(); j++) {
                    aux2 = (ArrayList)(VariablesVentas.vArrayList_Prod_XY.get(j));
    ...
    private void cargarConf(boolean valor) {
        ...
        VariablesVentas.vDescProm = descPromocion;
    ...
    private void setearProductoOriginal() {
        ...
        String codProdD;
        String cantProd;
        String cantFinalProd;
        String cantPack;
        
        if(indTipoPack.equals(ConstantsVentas.IND_PACK_MULTIPACK_VARIEDAD)){
            for (int c = 0; c < tableModelListaPaquete1.data.size(); c++) {
                list = (ArrayList)tableModelListaPaquete1.data.get(c);
                codProd = list.get(0).toString();
                cantProd = list.get(5).toString();
                cantPack = lblCantidad.getText();
                cantFinalProd = String.valueOf((Integer.parseInt(cantProd) * Integer.parseInt(cantPack)));
                ((ArrayList)tableModelListaPaquete1.data.get(c)).set(5, cantFinalProd);
                
                for(int d = 0; d < VariablesVentas.vArrayList_Prod_XY.size(); d++) {
                    listD = (ArrayList)VariablesVentas.vArrayList_Prod_XY.get(d);
                    codProdD = listD.get(0).toString();
                    if (codProdD.equals(codProd)) {
                        ((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(d)).add(25, cantFinalProd);
                        break;
                    }
                }
            }
            ...
            for (int c = 0; c < tableModelListaPaquete1.data.size(); c++) {
                ...
                if (codProd.equals(VariablesVentas.vCod_Prod)) {
                    ((ArrayList)tableModelListaPaquete1.data.get(c)).set(5, "1");
                    
                    for(int d = 0; d < VariablesVentas.vArrayList_Prod_XY.size(); d++) {
                        listD = (ArrayList)VariablesVentas.vArrayList_Prod_XY.get(d);
                        codProdD = listD.get(0).toString();
                        if (codProdD.equals(codProd)) {
                            ((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(d)).add(25, "1");
                            break;
                        }
                    }
                    break;
    ...
    private void buscarProducto(String codigo) {
        ...
        boolean flag = false;
        for (int c = 0; c < tableModelListaPaquete1.data.size(); c++) {
            cod = ((ArrayList)tableModelListaPaquete1.data.get(c)).get(0).toString();
            if (cod.equals(codigo)) {
                FarmaGridUtils.showCell(tblpaquete1, c, 5);                
                flag = true;
                break;
            }            
        }
        if (flag) {
            llamarSetearCantidad("1", 
                                 tblpaquete1.getSelectedRow());
        } else {
            FarmaUtility.showMessage(this, "Código inexistente", txtProd1);
        }
        txtProd1.setText("");
    }

    private void txtProd1_keyPressed(KeyEvent e) {
        FarmaGridUtils.aceptarTeclaPresionada(e, tblpaquete1, txtProd1, 1);
    ...
    private boolean isRowSelected() {
        boolean flag = true;
        int ind = tblpaquete1.getSelectedRow();
        if (ind < 0) {
            flag = false;
    ...
    private void llamarSetearCantidad(String opcion,
        ...
        if (isThereStock(opcion)) {
            String descProd = FarmaUtility.getValueFieldArrayList(tableModelListaPaquete1.data, indice, 1) + " " +
                                FarmaUtility.getValueFieldArrayList(tableModelListaPaquete1.data, indice, 2);
            String cantFraccionada = FarmaUtility.getValueFieldArrayList(tableModelListaPaquete1.data, indice, 12);
            DlgCantDetaVariedad02 dlgCantDetaVariedad02 = new DlgCantDetaVariedad02(myParentFrame, "", true);
            dlgCantDetaVariedad02.setTipoPantallaXoY("PACK");
            ...
            if (FarmaVariables.vAceptar) {
                if (opcion.equals("1")) {
                    ((ArrayList)tableModelListaPaquete1.data.get(indice)).set(5, VariablesVentas.cantidadDetalleVariedad);
                    FarmaGridUtils.showCell(tblpaquete1, indice, 5);
                } 
            } else {
                VariablesVentas.cantidadDetalleVariedad = " ";
            }
            ((ArrayList)VariablesVentas.vArrayList_Prod_XY.get(indice)).add(25, VariablesVentas.cantidadDetalleVariedad);
            calcularNumerosPack();
            //INI AOVIEDO 06/06/2017
            if(isPackCompleto()){
                muestraProductosVariedadXY();
    ...
    private boolean isThereStock(String opcion) {
        ...
        String stock = "0";
        if (opcion.equals("1")) {
            stock = FarmaUtility.getValueFieldArrayList(tableModelListaPaquete1.data, tblpaquete1.getSelectedRow(), 6).toString();
        }
    ...
    private int getCantIngresadaPaquete(String opcion) {
        ...
        if (opcion.equals("1")) {
            for (int c = 0; c < tableModelListaPaquete1.data.size(); c++) {
                ArrayList fila = (ArrayList)tableModelListaPaquete1.data.get(c);
                if (!fila.get(0).toString().equals(FarmaUtility.getValueFieldArrayList(tableModelListaPaquete1.data, tblpaquete1.getSelectedRow(), 0))) {
    ...
    private boolean isPackCompleto () {
        boolean flag = false;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                
        ...
        if (cantAtendida == cantSolicitada) {
            flag = true;
            lblMsgCompletado.setText("EL PACK YA ESTÁ COMPLETO");
        } else {
    ...
    private void txtProd1_keyReleased(KeyEvent e) {
        FarmaGridUtils.buscarDescripcion(e, tblpaquete1, txtProd1, 1);
    }
    ...
    //INI AOVIEDO 06/06/2017
    private void muestraProductosVariedadXY(){
        DlgDetalleProductosVariedadXY dlgDetalleProductosVariedadXY = new DlgDetalleProductosVariedadXY(myParentFrame, "", true, indTipoPack);
        dlgDetalleProductosVariedadXY.setCodProd(VariablesVentas.vCod_Prod);
        dlgDetalleProductosVariedadXY.lblCantidad.setText(lblCantidad.getText());
        //dlgDetalleProductosVariedadXY.setDescPromocion(tblPromociones.getValueAt(tblPromociones.getSelectedRow(), COL_DESC_LARGA).toString());
        dlgDetalleProductosVariedadXY.setVisible(true);
