...
public class DlgResumenReceta extends JDialog {
    ...
    private void initialize() {
        ...
        if (!VariablesCentroMedico.vVerReceta) {
            limpiaValoresPedido();
        }
    }
    ...
    private void operaResumenPedido() {
        ...
        for (int i = 0; i < VariablesCentroMedico.vArrayList_ResumenReceta.size(); i++) {
            tableModelResumenReceta.insertRow((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(i));
            tableModelResumenReceta.fireTableDataChanged();
        }
        tblProductos.repaint();
    ...
    private void calculaTotalesPedido() {
        ...
        for (int i = 0; i < VariablesCentroMedico.vArrayList_ResumenReceta.size(); i++) {
            ...
            cantidad = Integer.parseInt((String)((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(i)).get(4));
            totalBruto +=
                    FarmaUtility.getDecimalNumber((String)((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(i)).get(3)) *
                    cantidad;
            totalIGV +=
                    FarmaUtility.getDecimalNumber((String)((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(i)).get(12));
            totalNeto +=
                    FarmaUtility.getDecimalNumber((String)((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(i)).get(7));
        }
    ...
    log.debug("totalIGV : " + totalIGV);*/
        ...
        lblItems.setText(String.valueOf(VariablesCentroMedico.vArrayList_ResumenReceta.size()));
    }
    ...
    private void muestraIngresoCantidad() {
        ...
        VariablesCentroMedico.vCod_Prod = ((String)(tblProductos.getValueAt(filaActual, 0))).trim();
        VariablesCentroMedico.vDesc_Prod = ((String)(tblProductos.getValueAt(filaActual, 1))).trim();
        VariablesCentroMedico.vNom_Lab = ((String)(tblProductos.getValueAt(filaActual, 9))).trim();
        VariablesCentroMedico.vCant_Ingresada_Temp = ((String)(tblProductos.getValueAt(filaActual, 4))).trim();
        VariablesCentroMedico.vVal_Frac = ((String)(tblProductos.getValueAt(filaActual, 10))).trim();
        VariablesCentroMedico.vPorc_Igv_Prod = ((String)(tblProductos.getValueAt(filaActual, 11))).trim();
        VariablesCentroMedico.vPorc_Dcto_1 = ((String)(tblProductos.getValueAt(filaActual, 5))).trim();
        VariablesCentroMedico.vVal_Prec_Vta = ((String)(tblProductos.getValueAt(filaActual, 6))).trim();
    ...
    private void seleccionaProducto(int pFila) {
        VariablesCentroMedico.vTotalPrecVtaProd =
                (FarmaUtility.getDecimalNumber(VariablesCentroMedico.vCant_Ingresada) * FarmaUtility.getDecimalNumber(VariablesCentroMedico.vVal_Prec_Vta));
    ...
    private void operaProductoEnJTable(int pFila) {
        tblProductos.setValueAt(VariablesCentroMedico.vCant_Ingresada, pFila, 4); //cantidad ingresada
        tblProductos.setValueAt(FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber(VariablesCentroMedico.vPorc_Dcto_1),
                                                          2), pFila, 5); //PORC DCTO 1
        tblProductos.setValueAt(FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber(VariablesCentroMedico.vVal_Prec_Vta),
        ...
        tblProductos.setValueAt(FarmaUtility.formatNumber(VariablesCentroMedico.vTotalPrecVtaProd, 2), pFila,
                                7); //Total Precio Vta
        String valIgv =
            FarmaUtility.formatNumber((FarmaUtility.getDecimalNumber(VariablesCentroMedico.vVal_Prec_Vta) - (FarmaUtility.getDecimalNumber(VariablesCentroMedico.vVal_Prec_Vta) /
                                                                                                       (1 +
                                                                                                        (FarmaUtility.getDecimalNumber(VariablesCentroMedico.vPorc_Igv_Prod) /
                                                                                                         100)))) *
                                      FarmaUtility.getDecimalNumber(VariablesCentroMedico.vCant_Ingresada));
        //log.debug(valIgv);
        VariablesCentroMedico.vVal_Igv_Prod = valIgv;
        tblProductos.setValueAt(FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber(VariablesCentroMedico.vVal_Igv_Prod),
                                                          2), pFila, 12); //Total Igv Producto
        tblProductos.repaint();
    }

    private void operaProductoEnArrayList(int pFila) {
        ((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(pFila)).set(4, VariablesCentroMedico.vCant_Ingresada);
        ((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(pFila)).set(5,
                                                                             FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber(VariablesCentroMedico.vPorc_Dcto_1),
                                                                                                       2));
        ((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(pFila)).set(6,
                                                                             FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber(VariablesCentroMedico.vVal_Prec_Vta),
                                                                                                       3));
        ((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(pFila)).set(7,
                                                                             FarmaUtility.formatNumber(VariablesCentroMedico.vTotalPrecVtaProd,
                                                                                                       2));
        ((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(pFila)).set(12,
                                                                             FarmaUtility.formatNumber(FarmaUtility.getDecimalNumber(VariablesCentroMedico.vVal_Igv_Prod),
                                                                                                       2));
    }
    ...
    private void eliminaProductoResumenPedido() {
        ...
        String cantidad =
          ((String) (tblProductos.getValueAt(filaActual, 4))).trim();*/
                ...
                VariablesCentroMedico.vArrayList_ResumenReceta.remove(filaActual);
    ...
    private synchronized void grabarReceta() {
        ...
        try {
            VariablesCentroMedico.vNum_Ped_Rec = FarmaSearch.getNuSecNumeracion(FarmaConstants.COD_NUMERA_RECETA, 10);
            log.debug("VariablesReceta.vNum_Ped_Rec : " + VariablesCentroMedico.vNum_Ped_Rec);
    ...
    private void grabarDetallePedido(int pFila) throws Exception {
        VariablesCentroMedico.vSec_Ped_Vta_Det = String.valueOf(pFila + 1);
        VariablesCentroMedico.vCod_Prod =
                ((String)((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(pFila)).get(0)).trim();
        VariablesCentroMedico.vCant_Ingresada =
                String.valueOf(FarmaUtility.trunc(FarmaUtility.getDecimalNumber(((String)((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(pFila)).get(4)).trim())));
        VariablesCentroMedico.vVal_Prec_Vta =
                ((String)((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(pFila)).get(6)).trim();
        VariablesCentroMedico.vTotalPrecVtaProd =
                FarmaUtility.getDecimalNumber(((String)((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(pFila)).get(7)).trim());
        VariablesCentroMedico.vPorc_Dcto_1 =
                String.valueOf(FarmaUtility.getDecimalNumber(((String)((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(pFila)).get(5)).trim()));
        VariablesCentroMedico.vPorc_Dcto_Total =
                VariablesCentroMedico.vPorc_Dcto_1; //cuando es pedido normal, el descuento total siempre es el descuento 1
        VariablesCentroMedico.vVal_Frac =
                ((String)((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(pFila)).get(10)).trim();
        VariablesCentroMedico.vEst_Ped_Vta_Det = ConstantsVentas.ESTADO_PEDIDO_DETALLE_ACTIVO;
        VariablesCentroMedico.vVal_Prec_Lista =
                String.valueOf(FarmaUtility.getDecimalNumber(((String)((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(pFila)).get(3)).trim()));
        VariablesCentroMedico.vVal_Igv_Prod =
                ((String)((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(pFila)).get(11)).trim();
        VariablesCentroMedico.vUnid_Vta =
                ((String)((ArrayList)VariablesCentroMedico.vArrayList_ResumenReceta.get(pFila)).get(2)).trim();
        DBVentas.grabarDetalleReceta();
    }

    private void guardaVariablesPedidoCabecera() {
        VariablesCentroMedico.vVal_Bruto_Ped = lblBruto.getText().trim();
        VariablesCentroMedico.vVal_Neto_Ped = lblTotalS.getText().trim();
        VariablesCentroMedico.vVal_Redondeo_Ped = lblRedondeo.getText().trim();
        VariablesCentroMedico.vVal_Igv_Ped = lblIGV.getText().trim();
        VariablesCentroMedico.vVal_Dcto_Ped = lblDscto.getText().trim();
        VariablesCentroMedico.vCant_Items_Ped = lblItems.getText().trim();
        VariablesCentroMedico.vEst_Ped_Vta_Cab = ConstantsVentas.ESTADO_PEDIDO_DETALLE_ACTIVO;
    }
    ...
    private void limpiaValoresPedido() {
        ...
        VariablesCentroMedico.vVal_Prec_Vta = "";
        VariablesCentroMedico.vPorc_Dcto_1 = "";
        VariablesCentroMedico.vDesc_Acc_Terap = "";
        VariablesCentroMedico.vStk_Prod = "";
        VariablesCentroMedico.vStk_Prod_Fecha_Actual = "";
        VariablesCentroMedico.vVal_Frac = "";
        VariablesCentroMedico.vVal_Prec_Lista = "";
        VariablesCentroMedico.vVal_Igv_Prod = "";
        VariablesCentroMedico.vPorc_Igv_Prod = "";
        VariablesCentroMedico.vEst_Ped_Vta_Cab = "";

        VariablesCentroMedico.vCant_Ingresada = "";
        VariablesCentroMedico.vCant_Ingresada_Temp = "";
        VariablesCentroMedico.vTotalPrecVtaProd = 0;

        VariablesCentroMedico.vArrayList_PedidoReceta = new ArrayList();
        VariablesCentroMedico.vArrayList_ResumenReceta = new ArrayList();

        VariablesCentroMedico.vNum_Ped_Rec = "";
        VariablesCentroMedico.vVal_Bruto_Ped = "";
        VariablesCentroMedico.vVal_Neto_Ped = "";
        VariablesCentroMedico.vVal_Redondeo_Ped = "";
        VariablesCentroMedico.vVal_Igv_Ped = "";
        VariablesCentroMedico.vVal_Dcto_Ped = "";

        VariablesCentroMedico.vCant_Items_Ped = "";
        VariablesCentroMedico.vSec_Ped_Vta_Det = "";
        VariablesCentroMedico.vPorc_Dcto_Total = "";
        VariablesCentroMedico.vEst_Ped_Vta_Det = "";
