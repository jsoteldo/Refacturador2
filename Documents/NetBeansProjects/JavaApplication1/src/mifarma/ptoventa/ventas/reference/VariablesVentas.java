...
public class VariablesVentas {
    ...
    public static String vCadenaMetodo;
    public static boolean vIndCheck;

    public static boolean vResultadoORBIS = false;
    ...
    public static String vCant_Ingresada_ItemQuote = "";//LTAVARA 2016.11.14 
    public static double vTotalPrecVtaProd = 0;

    public static ArrayList vArrayList_PedidoVenta = new ArrayList();
    //dubilluz 2016.11.22 se comento el listado de resumen de pedido para proceder a calcular en base a listado de bean.
  ...
  FEC_CREA_PROMOCION , USU_MOD_PROMOCION , FEC_MOD_PROMOCION , ESTADO  */
    ...
    public static ArrayList vArrayList_CuponesFijos = new ArrayList();
    ...
    public static ArrayList vDetalleReceta = new ArrayList();
    // DUBILLUZ  31.08.2016
    
    public static String vTmpNumReceta = "";
    
    public static String cantidadDetalleVariedad = "0";
    
    public static String vCod_Prod_Regalo = "";
    public static String vCodEquiValenteAcumula  = "";
    
    public static ArrayList vArrayList_Variedad_Automatica = new ArrayList();
    
    /**
     * Array para las Promociones de XY
     * @author : AOVIEDO
     * @since  : 07/06/2017
     */
    public static ArrayList vArrayList_Prod_XY = new ArrayList();
    
    /**
     * Array para las Promociones Regalo de XY
     * @author : AOVIEDO
     * @since  : 07/06/2017
     */
    public static ArrayList vArrayList_Prod_XY_Regalos = new ArrayList();
    
    /**
     * Cantidad de Packs seleccionados para Pack Variedad XY
     * @author : AOVIEDO
     * @since  : 07/06/2017
     */
    public static String sCantidadPackXY = "";
    
    
    public static ArrayList vArrayList_Prom_Aux_XX = new ArrayList();
    public static ArrayList vArrayList_Prod_Prom_Aux_XX = new ArrayList();
    
    public static FarmaTableModel tableModelListaGlobalProductosInsumo; //AOVIEDO 10/01/2018
    
    /**
     * Mostrar reporte vendedor, avances de metas de ventas diarias
     * @author : RARGUMEDO
     * @since  : 28/03/2018
     */
    public static boolean verMetasVendedor = false;
	
    //INI DMOSQUEIRA 20190710
    public static String vCostoICBPER = "0.00";
    public static String vTotalICBPER = "0.00";
    public static String vCostoICBPER_Ped = "0.00";
