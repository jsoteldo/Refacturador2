 ...
 *
 */
public class VariablesConvalidado {
    ...
    //ERIOS 26.09.2016
    public static boolean bAlmacenMixto =  false;
    public static String strCodAlmacen = "";
    public static String vDescDestino_Transf = "";
    ...
    public static FarmaTableModel tableModelEspecial =
        new FarmaTableModel(ConstantsInventario.columnsListaProductosEspeciales, ConstantsInventario.defaultValuesListaProductosEspeciales, 0);
    
    /*** Inicio CCASTILLO 10/10/2016 ***/
     public static FarmaTableModel tableModelEspecialInicial=
         new FarmaTableModel(ConstantsInventario.columnsListaProductosEspeciales, ConstantsInventario.defaultValuesListaProductosEspeciales, 0);
     public static FarmaTableModel tableModelEspecialNor =
         new FarmaTableModel(ConstantsInventario.columnsListaProductosEspeciales, ConstantsInventario.defaultValuesListaProductosEspeciales, 0);
    public static FarmaTableModel tableModelEspecialIns =
        new FarmaTableModel(ConstantsInventario.columnsListaProductosEspeciales, ConstantsInventario.defaultValuesListaProductosEspeciales, 0);
    
    public static int vTipoPedidoEsp=-1;
    ...
    public static String vCodTipProceso="";//LTAVARA - 05/12/2016
    public static String vDescTipProceso;//LTAVARA - 05/12/2016
    
    //datos transportista mercaderia directa
    public static String vNombreTrans="";
    public static String vDNITrans="";
    public static String vPlacaTrans="";
    
    //LTAVARA 2017.07.27
    public static String vSecCabOrdComp="";
