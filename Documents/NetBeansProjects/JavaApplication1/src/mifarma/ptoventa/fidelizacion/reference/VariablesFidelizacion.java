...
public class VariablesFidelizacion {
    ...
    public static BeanAfiliadoLocal clienteFidelizado = null;
    ...
    public static boolean vIsPrimeraCompraFidelizadoNuevo = false;
    public static boolean vExcluyeAcumula = false; // AOVIEDO 17/05/2017
    
    public static String vCodFormaPagoCampanasR = ""; //AOVIEDO 26/06/2017
    public static int vNumCuponCampanasR = 0; //AOVIEDO 28/06/2017
    public static String vTipCuponCampanasR = ""; //AOVIEDO 28/06/2017
    public static String vCodCuponIngresadoCampanasR = ""; //AOVIEDO 30/06/2017
}
