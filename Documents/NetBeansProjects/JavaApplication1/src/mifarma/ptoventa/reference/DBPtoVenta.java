...
public class DBPtoVenta {
    ...
    public static String getDirectorioComprobantes() throws SQLException {
     ...
     /**
     * Obtiene directorio de plantillas
     * @author JMONZALVE
     * @since 24.04.2019
     * @return
     * @throws SQLException
     */
    public static String getDirectorioPlantillas() throws SQLException {
        parametros = new ArrayList();
        return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_CONV_COBRO_RESP.GET_DIRECTORIO_PLANTILLAS()", parametros);
    }
   ...
   public static String validarProdRefrig(String pCodProd) throws SQLException {
     ...
     * Recupera el mensaje o argumento descriptor del producvto para mostrar en el label
    */
    static String getMsjArgumento_Producto(String codigoProducto) throws SQLException {
        ArrayList parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(codigoProducto);
        log.debug("PTOVENTA_VTA_LISTA.GET_MSJ_ARGUMENTO_PROD(?,?)" + parametros);
        return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_VTA_LISTA.GET_MSJ_ARGUMENTO_PROD(?,?)", parametros);
    }
    /*
    ...
    public static boolean getValidaIngresoProdInRetail(String codigoProducto, String codDestinoTransf) throws SQLException {
        ArrayList parametros = new ArrayList();
        parametros.add(FarmaVariables.vCodGrupoCia);
        parametros.add(FarmaVariables.vCodLocal);
        parametros.add(codigoProducto);
        parametros.add(codDestinoTransf);
        log.debug("PTOVENTA_GRAL.GET_VALIDA_PROD_INRETAIL(?,?,?,?)" + parametros);
        return FarmaDBUtility.executeSQLStoredProcedureStr("PTOVENTA_GRAL.GET_VALIDA_PROD_INRETAIL(?,?,?,?)", parametros).equalsIgnoreCase("S")?true:false;
    }
