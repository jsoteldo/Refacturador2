...
public class DlgPedidoDiario extends JDialog {
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(649, 478));
        ...
        jLabelWhite1.setText("Total Dscto. Personal "+ConstantesUtil.simboloSoles);
        ...
        jLabelWhite3.setText("Total Venta "+ConstantesUtil.simboloSoles);
        ...
        jLabelFunction2.setForeground(new java.awt.Color(32, 105, 29));
        ...
        jLabelFunction3.setForeground(new java.awt.Color(32, 105, 29));
        jLabelWhite5.setText("Total "+ConstantesUtil.simboloSoles);
        jLabelWhite5.setBounds(new Rectangle(460, 0, 50, 25));
        jLabelWhite6.setText("Redondeo "+ConstantesUtil.simboloSoles);
        jLabelWhite6.setBounds(new Rectangle(30, 0, 80, 25));
        lblRedondeo.setText("0");
        lblRedondeo.setBounds(new Rectangle(110, 0, 80, 25));
        lblDiferencia.setText("Existe una diferencia de "+ConstantesUtil.simboloSoles);
    ...
    public void eliminaPedidoTemporal() {
        if (JConfirmDialog.rptaConfirmDialog(this, "¿Seguro que desea salir del pedido?")) {
            try {
