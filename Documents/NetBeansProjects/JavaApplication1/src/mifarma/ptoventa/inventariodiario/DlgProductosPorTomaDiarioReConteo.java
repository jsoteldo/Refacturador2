...
public class DlgProductosPorTomaDiarioReConteo extends JDialog {
    ...
    private void jbInit() throws Exception {
        ...
        lblContinuar.setBackground(SystemColor.window);
        lblContinuar.setBorder(BorderFactory.createEmptyBorder(0, 0, 0, 0));
        lblContinuar.setFont(new Font("SansSerif", 1, 11));
        lblContinuar.setForeground(new java.awt.Color(32, 105, 29));
