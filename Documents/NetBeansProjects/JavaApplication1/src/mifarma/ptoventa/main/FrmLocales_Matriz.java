...
public class FrmLocales_Matriz extends JFrame {
    ...
    private void cargaListaLocales() {
        try {
            DBPtoVenta.cargaListaMaestros(tableModel, ConstantsPtoVenta.LISTA_LOCAL,null);
    ...
    private void funcionF11() {
        ...
        */
        ...
        if(indMenu.equalsIgnoreCase("S")){
            FrmEconoMenuFar frameMenu= new FrmEconoMenuFar();
            FarmaUtility.centrarVentana(frameMenu);
    ...
    private void cargaLocal() {
        ...
        log.debug("NXS => FarmaVariables.vCodLocal=" + FarmaVariables.vCodLocal);
    }
}
