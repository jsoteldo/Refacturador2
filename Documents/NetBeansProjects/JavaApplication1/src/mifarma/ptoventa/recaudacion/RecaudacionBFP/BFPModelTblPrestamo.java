...
public class BFPModelTblPrestamo  implements TableModel
{
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        {
            case 0:
                return aux.getTipoPrestamo();
            case 1:
                return aux.getNroPrestamo();
            case 2:
                return aux.getFechaPagoPrestamo();
            case 3:
                return aux.getDesc_Prestamo();
            case 4:
                return aux.getMontoPagoPres();
            case 5:
    ...
    public void anhadeDatosPago (RegistroOperacion nuevoDato)
    {
    ...
    {   
        ...
        {
            case 0:
                aux.setTipoPrestamo((String)aValue);
                break;
            case 1:
                aux.setNroPrestamo((String)aValue);
                break;
            case 2:
                aux.setFechaPagoPrestamo((String)aValue);
                break;
            case 3:
                aux.setDesc_Prestamo((String)aValue);
                break;
            case 4:
                aux.setMontoPagoPres((String)aValue);
                break;
            case 5:
