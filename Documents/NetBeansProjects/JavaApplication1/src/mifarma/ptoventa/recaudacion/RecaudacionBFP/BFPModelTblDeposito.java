...
public class BFPModelTblDeposito  implements TableModel
{
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        {
            case 0:
                return aux.getIdCtaDeposito();
            case 1:
                return aux.getDesc_CtaDeposito();
            case 2:
                return aux.getSaldoCtaDeposito();
            case 3:
    ...
    {   
        ...
        {
            case 0:
                aux.setIdCtaDeposito((String)aValue);
                break;
            case 1:
                aux.setDesc_CtaDeposito((String)aValue);
                break;
            case 2:
                aux.setSaldoCtaDeposito((String)aValue);
                break;
            case 3:
