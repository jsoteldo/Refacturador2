...
public class DlgGuiasPendientes extends JDialog {
    ...
    //private static final int COL_ALMACEN = 4;
    private static final int COL_NUM_NOTA = 5;
    private static final int COL_ESTADO = 6;
    private static final int COL_PAG = 7;
    private static final int COL_ITEMS = 8;
    private static final int COL_PRODS = 9;
    ...
    private void jbInit() throws Exception {
        this.setSize(new Dimension(505, 478));
        ...
        pnlHeader1.setBounds(new Rectangle(5, 10, 480, 50));
        pnlTitle1.setBounds(new Rectangle(5, 135, 480, 25));
        lblEsc.setText("[ ESC ] Cerrar");
        lblEsc.setBounds(new Rectangle(395, 420, 90, 20));
        lblF11.setText("[ F11 ] Aceptar");
        lblF11.setBounds(new Rectangle(290, 420, 100, 20));
        lblF5.setText("[ F5 ]  Todos/ Ninguno");
        lblF5.setBounds(new Rectangle(345, 395, 140, 20));
        ...
        txtLocal.setBounds(new Rectangle(75, 15, 385, 20));
        ...
        scrListaLocales.setBounds(new Rectangle(5, 160, 480, 230));
        ...
        jLabelWhite1.setBounds(new Rectangle(385, 0, 35, 25));
        lblCant.setText("0");
        lblCant.setBounds(new Rectangle(425, 0, 55, 25));
